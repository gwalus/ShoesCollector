...
{
    public class UpdateProductViewModel : BindableBase
    {
        ...
        private string _buttonContent = "Update";
        ...
        private bool _isUpdateModel = false;

        public bool IsUpdateModel
        {
            get { return _isUpdateModel; }
            set { SetProperty(ref _isUpdateModel, value); }
        }
